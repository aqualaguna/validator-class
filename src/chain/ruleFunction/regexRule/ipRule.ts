export default function ipRule (data: any, params: any) {
...
ipRule.getErrorMessage = function (attribute_name: string, params: any) {
  return `${attribute_name} must match ip format.`;
}
