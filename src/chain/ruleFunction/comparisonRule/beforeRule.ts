...
export default function beforeRule (data: any, params: any) {
...
beforeRule.getErrorMessage = function (attribute_name: string, params: any) {
  return `${attribute_name} must before ${params.value.join(',')}.`;
}