...
export default function beforeEqualRule (data: any, params: any) {
...
beforeEqualRule.getErrorMessage = function (attribute_name: string, params: any) {
  return `${attribute_name} must before or equal ${params.value.join(',')}.`;
}