...
export default function gtRule (data: any, params: any) {
...
gtRule.getErrorMessage = function (attribute_name: string, params: any) {
  return `${attribute_name} must greater than ${params.value}`;
}