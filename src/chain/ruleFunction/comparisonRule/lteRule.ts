...
export default function lteRule (data: any, params: any) {
...
lteRule.getErrorMessage = function (attribute_name: string, params: any) {
  return `${attribute_name} must less than or equal ${params.value}`;
}